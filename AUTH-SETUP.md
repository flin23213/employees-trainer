...
База восстановлена из приостановленного состояния; статус ACTIVE_HEALTHY и тестовый SELECT успешны. В публичных настройках включён только email; Google и GitHub отключены. Приложения OAuth и их секреты в этой сессии не предоставлены. Вход через внешние сервисы требует завершения настроек выше.
